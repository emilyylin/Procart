  ...
  return (
    <div className="navbar">
        <div className="navbar-border"> </div>
            <li><a onClick={() => goTo(History)}> <img className="navbar-icon" src={BlackHistory} alt="history"></img> </a></li>
            <li><a onClick={() => goTo(Cart)}> <img className="navbar-icon" src={BlackCart} alt="cart"></img> </a></li>
            <li><a onClick={() => goTo(Budget)}> <img className="navbar-icon" src={PinkBudget} alt="budget"></img> </a></li>
    </div>
  );
}
